	...
	const mockExtensionDetails: ExtensionDetails[] = [
		{
			id: "ext1",
			name: "Extension One",
			fullName: "author1/ext1",
			owner: "author1",
			description: "First test extension",
			stars: 100,
			license: "MIT",
			htmlUrl: "https://github.com/author1/ext1",
			version: "1.0.0",
			tag: "v1.0.0",
			template: false,
			contributes: ["filters"],
		},
		{
			id: "ext2",
			name: "Extension Two",
			fullName: "author2/ext2",
			owner: "author2",
			description: "Second test extension",
			stars: 50,
			license: "Apache-2.0",
			htmlUrl: "https://github.com/author2/ext2",
			version: "2.1.0",
			tag: "v2.1.0",
			template: true,
			contributes: ["formats"],
		},
		{
			...
			fullName: "author3/ext3",
			owner: "author3",
			description: "Third test extension",
			stars: 25,
			license: "GPL-3.0",
			htmlUrl: "https://github.com/author3/ext3",
			version: "0.5.0",
			tag: "v0.5.0",
			template: false,
	...
	suite("createExtensionItems", () => {
		...
		test("Should handle extension with missing optional fields", () => {
			const minimalExtension: ExtensionDetails = {
				...
				stars: 0,
				license: "Unknown",
				htmlUrl: "https://github.com/user/minimal",
				version: "1.0.0",
				tag: "v1.0.0",
				template: false,
				contributes: [],
			...
			const specialExtensions: ExtensionDetails[] = [
				{
					...
					fullName: "special/ext",
					owner: "special",
					description: "Extension with special characters: <>&\"'",
					stars: 9999,
					license: "Custom License",
					htmlUrl: "https://github.com/special/ext",
					version: "1.0.0-beta",
					tag: "v1.0.0-beta",
					template: true,
