...
suite("Extension Details Test Suite", () => {
	...
	const mockExtensionData = {
		"mcanouil/quarto-github": {
			...
			"description": "Use GitHub short references (commits, issues, discussions, and pull requests) directly into your Quarto documents.",
			"latestRelease": "1.0.1",
			...
			"openGraphImageUrl": "https://repository-images.githubusercontent.com/828525647/516f4d12-3326-4ba1-bc80-d5fec8c5b0bf",
			"owner": "mcanouil",
		...
		"mcanouil/quarto-highlight-text": {
			...
			"defaultBranchRef": "main",
			"description": "Quarto extension that allows to highlight text in a document for various formats: HTML, LaTeX, Typst, Reveal.js, Beamer, PowerPoint, and Docx.",
			"latestRelease": "1.3.3",
			...
			"openGraphImageUrl": "https://repository-images.githubusercontent.com/795686327/7503a7fe-546d-4d0d-a638-564a090e7627",
			"owner": "mcanouil",
	...
	test("getExtensionsDetails - Should handle template and non-template extensions correctly", async () => {
		...
		assert.strictEqual(template?.templateContent, "# Template Content\n\nThis is a template.", "Template should have content");
	});
