...
The vocabulary and the validator version together.
Version 2 of the vocabulary is implemented by version 2 of the module, and a future version 3 of the vocabulary ships with the matching module.
The version of the module is therefore the version of the vocabulary, and not the version of the `@quarto-wizard/schema` package that publishes both.
