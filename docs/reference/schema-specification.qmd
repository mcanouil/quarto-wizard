...
```yaml
$schema: https://mcanouil.github.io/quarto-wizard/schemas/extension/v1
options:
  threshold:
    type: number
```
...
- `https://mcanouil.github.io/quarto-wizard/schemas/extension/v1`
...
- `packages/core/assets/schema/extension-schema.yml` (YAML format, kebab-case keys).
- `packages/core/assets/schema/extension-schema.json` (JSON format, camelCase keys).
...
Optionally include `$schema: https://mcanouil.github.io/quarto-wizard/schemas/extension/v1`
at the top level.
```
