...
### Sign In with GitHub Session

**Command**: `Quarto Wizard: Sign In with GitHub Session`

Authorise Quarto Wizard to use your VSCode GitHub session for private repositories.
Once signed in, Quarto Wizard silently reuses the session for subsequent operations.

### Clear GitHub Authentication

**Command**: `Quarto Wizard: Clear GitHub Authentication`

Remove the manually set GitHub token and revoke Quarto Wizard's use of the VSCode GitHub session.
This does not sign you out of GitHub in VSCode.
