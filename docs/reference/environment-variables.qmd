...
Authentication configuration types. Quarto Wizard supports GitHub authentication via environment variables.
...
Proxy configuration from environment variables. Quarto Wizard respects standard proxy environment variables for network requests.
