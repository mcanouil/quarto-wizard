...
alt-text:
  explorer-view: |
    The Quarto Wizard Explorer View showing workspace folders and installed extensions with action buttons for installing, using templates, and managing extensions.
  reprex-command-2: |
...
- **Extension snippets**: Snippets declared by extensions via `_snippets.json` files.
