...
alt-text:
  ...
  explorer-view-version: |
    An expanded extension showing a warning icon, metadata rows including Quarto required and Compatibility set to incompatible, and a tooltip with the version mismatch message.
  explorer-view-schema: |
    An expanded extension showing a Schema node with grouped sections for Options, Shortcodes, Formats, and Element Attributes, each listing their fields and types.
  explorer-view-snippets: |
    An expanded extension showing a Snippets node with snippet entries and a tooltip previewing the snippet content.
  editor-context: |
...
::: {style="text-align: center;"}
![](images/explorer-view-version-dark.png "Extension Compatibility Details"){
.dark-content .lightbox
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-dark"
fig-alt='{{< meta alt-text.explorer-view-version >}}'
}
![](images/explorer-view-version-light.png "Extension Compatibility Details"){
.light-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-light"
fig-alt='{{< meta alt-text.explorer-view-version >}}'
...
::: {style="text-align: center;"}
![](images/explorer-view-schema-dark.png "Schema Node with Grouped Sections"){
.dark-content .lightbox
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-dark"
fig-alt='{{< meta alt-text.explorer-view-schema >}}'
}
![](images/explorer-view-schema-light.png "Schema Node with Grouped Sections"){
.light-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-light"
fig-alt='{{< meta alt-text.explorer-view-schema >}}'
...
::: {style="text-align: center;"}
![](images/explorer-view-snippets-dark.png "Snippets Node with Tooltip Preview"){
.dark-content .lightbox
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-dark"
fig-alt='{{< meta alt-text.explorer-view-snippets >}}'
}
![](images/explorer-view-snippets-light.png "Snippets Node with Tooltip Preview"){
.light-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-light"
fig-alt='{{< meta alt-text.explorer-view-snippets >}}'
