...
An inline unit is shown in the panel and in a hover, the same surfaces a block uses.
It carries no code lens, since a code lens needs a line of its own above a block, and an inline span has none.
