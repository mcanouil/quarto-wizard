...
1. If the source contains multiple extensions in an `_extensions/` folder, you will be prompted to select which ones to install.
2. Choose the target workspace folder (if multiple workspaces are open).
3. If an extension already exists, you will be asked to confirm before overwriting.
...
::: {style="text-align: center;"}
![](images/extension-selection-dark.png "Explorer Context Menu"){
.dark-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-dark"
fig-alt='{{< meta alt-text.extension-selection >}}'
}
![](images/extension-selection-light.png "Explorer Context Menu"){
.light-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-light"
fig-alt='{{< meta alt-text.extension-selection >}}'
...
::: {style="text-align: center;"}
![](images/conflict-resolution-dark.png "Extensions View: Marketplace"){
.dark-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-dark"
fig-alt='{{< meta alt-text.conflict-resolution >}}'
}
![](images/conflict-resolution-light.png "Extensions View: Marketplace"){
.light-content
.img-fluid .img-thumbnail .rounded-3 .border-light
width="500px" fig-align="center" group="quarto-wizard-light"
fig-alt='{{< meta alt-text.conflict-resolution >}}'
...
::: {.callout-tip}
Multi-extension selection is available when installing from any source (GitHub, URL, or local) that contains multiple extensions in an `_extensions/` folder.
If the source contains a single extension, it is installed directly.
:::
