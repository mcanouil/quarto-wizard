...
Defined in: [packages/core/src/proxy/config.ts:46](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L46)
...
| ------------------------------------- | ---------- | ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="httpproxy"></a> `httpProxy?`   | `string`   | Proxy URL for HTTP requests.                | [packages/core/src/proxy/config.ts:48](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L48) |
| <a id="httpsproxy"></a> `httpsProxy?` | `string`   | Proxy URL for HTTPS requests.               | [packages/core/src/proxy/config.ts:50](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L50) |
| <a id="noproxy"></a> `noProxy`        | `string[]` | List of hosts/patterns to bypass the proxy. | [packages/core/src/proxy/config.ts:52](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L52) |
...
Defined in: [packages/core/src/proxy/config.ts:88](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L88)
...
Defined in: [packages/core/src/proxy/config.ts:146](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L146)
...
Defined in: [packages/core/src/proxy/config.ts:109](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/config.ts#L109)
...
Defined in: [packages/core/src/proxy/fetch.ts:72](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/fetch.ts#L72)
...
| <a id="proxyconfig"></a> `proxyConfig?`       | [`ProxyConfig`](proxy.qmd#proxyconfig) | Proxy configuration. If not provided, reads from environment. | -                            | [packages/core/src/proxy/fetch.ts:74](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/fetch.ts#L74) |
...
Defined in: [packages/core/src/proxy/fetch.ts:137](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/fetch.ts#L137)
...
Defined in: [packages/core/src/proxy/fetch.ts:109](https://github.com/mcanouil/quarto-wizard/blob/3523b387239b45806be480a658befb5dfe299b76/packages/core/src/proxy/fetch.ts#L109)
